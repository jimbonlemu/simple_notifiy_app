...
class NotificationHelper {
  ...
  static NotificationHelper? _instace;

  NotificationHelper._internal() {
    _instace = this;
  }

  factory NotificationHelper() => _instace ?? NotificationHelper._internal();
  ...
  Future<void> showNotification(
    ...
    await flutterLocalNotificationsPlugin.show(
        0, 'plain title', 'plain body', platformChannelSpecifcs,
        payload: 'plain notifications');
  }

  Future<void> showNotificationsWithNoBody(
      FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin) async {
    var androidPlatformChannelSpecifics = const AndroidNotificationDetails(
  ...
  Future<void> scheduleNotification(
    ...
    var vibrationPattern = Int64List(64);
  ...
  Future<void> showGroupNotifications(
    ...
    var secondNotificationsPlatformSpecifics =
    ...
    await flutterLocalNotificationsPlugin.show(
      ...
      secondNotificationsPlatformSpecifics,
    );
  ...
  Future<void> showBigPictureNotification(
    ...
    var bigPictureStyleInformation = BigPictureStyleInformation(
      ...
      contentTitle: 'overridden <big>big</big> content title',
